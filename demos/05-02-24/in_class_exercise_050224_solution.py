...
p_positive_and_no_cancer = p_positive_given_no_cancer * (1-p_cancer)
...
path_pos = Path(r"tiny-test/hw3-pos/")
path_neg = Path(r"tiny-test/hw3-neg/")

# Step 2: Read files and folders in this path

filelist_pos = path_pos.glob("*.txt")
filelist_neg = path_neg.glob("*.txt")
...
filelist_pos_list = [[i.stem, "pos", "tiny-test", cleanFileContents(i)] for i in filelist_pos]
filelist_neg_list = [[i.stem, "pos", "tiny-test", cleanFileContents(i)] for i in filelist_pos]
