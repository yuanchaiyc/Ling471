...
p_cancer = None
p_positive_given_cancer = None
p_positive_given_no_cancer = None
...
p_other_given_to_the = None
p_wrong_given_to_the = None
...
filelist_pos_list = None
filelist_neg_list = None
