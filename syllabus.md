...
April 22 | [Text processing, contd. Unicode. Evaluation. ](slides/0422.pdf) [VS Code settings](demos/setting-up-vs-code.md)  | [Precision and recall](https://medium.com/@shrutisaxena0617/precision-vs-recall-386cf9f89488)  | 
April 27 | Metrics. Data science and probability | [A mathy tutorial](https://tutors4you.com/probabilitytutorial.htm) -- try to work through a couple problems of different types, listed there at the end. | [Assignment 2](assignments/Assignment2.md) 
